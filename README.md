...
- **$25 for the bundle** — the big hero button + the "Or grab all 22 for $25" nudge under the grid
...
|---|---|
| `BUY_BUNDLE_URL` | Bundle ($25) — appears **twice** (hero button + bundle nudge) |
...
- Change pricing → search for `$5` and `$25` in `index.html`. Currently 1
